...
function M.create_win_vertical(reference,direction,content_opts,height)
  -- for vertical layout, height is optional
...
function M.create_win_horizontal(reference,direction,content_opts,width)
  -- for horizontal layout, width is optional
  local winconfig = api.nvim_win_get_config(reference)
  local opts = {
    relative = 'editor',
    no_size_override = true,
